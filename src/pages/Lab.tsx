  ...
  return (
    <>
      <Seo
        ...
        description="Watch a shared Deriv demo scan volatility markets, metals, FX pairs and BTC/ETH on 5-minute through daily charts. RSI 20/80, one contract at a time, practice funds only."
        path="/lab"
      ...
      <section className="section">
        ...
        <p className="text-muted-foreground" style={{ maxWidth: '42rem', margin: '12px 0 16px' }}>
          You do not need an account to watch. The grid is volatility indices, Gold/Silver/Palladium/Platinum, major and minor FX pairs, and BTC/ETH. Not Boom, Crash or Step. Charts: 5m, 10m, 15m, 30m, 1h, 2h, 4h, 8h and daily. Demo funds only. Partner link {affiliateConfig.primaryAffiliateLink} · referral {affiliateConfig.referralCode}.
        </p>
        <div className="page-share">
          <ShareBar
            ...
            text="Volatility, metals, FX pairs and BTC/ETH on nine charts. RSI 20/80. Demo funds only."
          />
        </div>
        <PublicLiveBoard />
      </section>
