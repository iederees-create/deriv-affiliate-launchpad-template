  ...
  return (
    <>
      <Seo
        ...
        description="Watch a shared Deriv demo scan volatility, metals, FX pairs, BTC/ETH and stock indices on 5-minute through daily charts. RSI 20/80, one contract at a time, practice funds only."
        path="/lab"
      ...
      <section className="section">
        ...
        <div className="page-share">
          <ShareBar
            ...
            text="Volatility, metals, FX pairs, BTC/ETH and stock indices on nine charts. RSI 20/80. Demo funds only."
          />
        </div>
        <PublicLiveBoard />
      </section>
